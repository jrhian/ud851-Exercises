...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewPartySizeEditText = (EditText) this.findViewById(R.id.party_size_text_view);
    ...
    public void addToWaitlist(View view) {
        ...
        mAdapter.swapCusor((getAllGuests()));
    ...
    private long addNewGuest(String name, int partySize) {
        ...
        // COMPLETED (8) call insert to run an insert qbuery on TABLE_NAME with the ContentValues created
    }
}