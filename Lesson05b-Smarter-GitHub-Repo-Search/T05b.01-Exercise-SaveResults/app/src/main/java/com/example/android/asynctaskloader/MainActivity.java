...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String QUERY_URL = "search query";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String QUERY_JSON = "raw JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            String rawJson = savedInstanceState.getString(QUERY_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(QUERY_JSON, rawJson);
    }
