...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPELTED (2) Create a GreenAdapter variable called mAdapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED - REVIEW WHYYY THIS VARIABLE CREATION IS SO DIFFERENT (5) Create a LinearLayoutManager variable called layoutManager
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);

        // COMPLETED - REVIEW (6) Use setLayoutManager on mNumbersList with the LinearLayoutManager we created above
